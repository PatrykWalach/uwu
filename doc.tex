...
\begin{titlepage}
  ...
  \begin{tabular}{c@{\hspace{21mm}}|@{\hspace{5mm}}l}
    \vspace{-20mm} &                                                                   \\
    \multicolumn{2}{l}{\hspace{-12.5mm} \includegraphics[width=8cm]{app/assets/LogoUMCS.jpg}}     \\
...
\lstinputlisting[firstline=15]{app/examples/currying.uwu}
\newpage

\lstinputlisting[firstline=15]{app/examples/currying.uwu.js}
...
\begin{itemize}
  ...
  \item Przykład --- funkcja łącząca dwie posortowane tablice
        \lstinputlisting[firstline=25]{app/examples/merge.uwu}\newpage
        \lstinputlisting[firstline=19]{app/examples/merge.uwu.js}
\end{itemize}
...
\lstinputlisting[firstline=15]{app/examples/return.uwu}
\lstinputlisting[firstline=15]{app/examples/return.uwu.js}
...
\lstinputlisting[firstline=188, lastline=195]{app/parser.py}
W przypadku zbiorów wyrażeń zwracane są listy.
\lstinputlisting[firstline=369, lastline=375]{app/parser.py}
...
\end{itemize}
\lstinputlisting[firstline=72, lastline=80]{app/case_tree.py}
W innym przypadku wybieramy wzorzec przy pomocy heurystyki
\lstinputlisting[firstline=81, lastline=88]{app/case_tree.py}
...
\begin{itemize}
  \item Przypadek nie zawiera wzorca, więc dodajemy go do \lstinline{yes} i \lstinline{no}
        \lstinputlisting[firstline=90, lastline=95]{app/case_tree.py}\newpage
  \item Przypadek zawiera szukany wzorzec, więc dodajemy go do \lstinline{yes}
        \lstinputlisting[firstline=97, lastline=108]{app/case_tree.py}
  \item Przypadek zawiera wzorzec, więc dodajemy go do \lstinline{no}
        \lstinputlisting[firstline=110, lastline=111]{app/case_tree.py}
\end{itemize}

Rekursywnie generujemy kod dla \lstinline{yes} i \lstinline{no} i zwracamy gałąź decyzyjną
\lstinputlisting[firstline=116, lastline=118]{app/case_tree.py}\newpage
...
\lstinputlisting[firstline=28, lastline=34]{app/algorithm_j.py}
Substytucje to pary zmiennych i typów
\lstinputlisting[firstline=25, lastline=25]{app/algorithm_j.py}
...
\lstinputlisting[firstline=26, lastline=26]{app/algorithm_j.py}
gdzie schemat zawiera informację o typie oraz listę występujących w nim zmiennych typów

\lstinputlisting[firstline=12, lastline=16]{app/algorithm_j.py}
\newpage
...
\lstinputlisting[firstline=37, lastline=46]{app/algorithm_j.py}

Tworzymy funkcję, unifikującą dwa typy

\lstinputlisting[firstline=95, lastline=112]{app/algorithm_j.py}\newpage
wraz z funkcją generującą substytucje w przypadku unifikacji zmiennego typu
\lstinputlisting[firstline=115, lastline=124]{app/algorithm_j.py}
Teraz zaczynamy implementację algorytmu J.

\subsection{Literały}
W przypadku literałów typ jest oczywisty.

\lstinputlisting[firstline=164, lastline=171]{app/algorithm_j.py}
...
\lstinputlisting[firstline=172, lastline=173]{app/algorithm_j.py}\newpage
\subsection{Bloki wyrażeń}
W przypadku bloku wyrażeń inferujemy typ każdego z nich i zwracamy ostatni typ.
\lstinputlisting[firstline=185, lastline=192]{app/algorithm_j.py}
...
\lstinputlisting[firstline=257, lastline=263]{app/algorithm_j.py}
...
\end{itemize}
\lstinputlisting[firstline=323, lastline=335]{app/algorithm_j.py}
...
\lstinputlisting[firstline=361, lastline=373]{app/algorithm_j.py}
\newpage
...
\lstinputlisting[firstline=336, lastline=360]{app/algorithm_j.py}
...
\lstinputlisting[firstline=508, lastline=520]{app/algorithm_j.py}

W przypadku gałęzi decyzyjnej inferujemy typ zmiennej i sprawdzanego konstruktora
\lstinputlisting[firstline=521, lastline=527]{app/algorithm_j.py}
...
\lstinputlisting[firstline=46, lastline=56]{app/compile.py}
\lstinputlisting[firstline=13, lastline=21]{app/compile.py}

W przypadku deklaracji zmiennych i funkcji, dodajemy elementy do listy wyrażeń do windowania.
\lstinputlisting[firstline=62, lastline=72]{app/compile.py}
W każdym innym przypadku lista wyrażeń do windowania jest po prostu przepuszczana dalej.
\lstinputlisting[firstline=81, lastline=89]{app/compile.py}
...
\lstinputlisting[firstline=145, lastline=152]{app/compile.py}
\newpage
\subsection{Wyrażenia warunkowe}
...
\lstinputlisting[firstline=170, lastline=171]{app/compile.py}

\subsection{Warianty}
Warianty przyjmują postać obiektów z dyskryminatorem
\lstinputlisting[firstline=187, lastline=190]{app/compile.py}
...
\lstinputlisting[firstline=262, lastline=267]{app/compile.py}
\newpage
...
\lstinputlisting[firstline=268, lastline=284]{app/compile.py}
