...
Algorytm W nie ma żadnych side-effectów, i świetnie zajmuje się aplikowanie i komponowaniem substytucji w odpowiedniej kolejności. Te powtórne apikacje substytucji na wyrażeniach mogą znacznie zmniejszyć wydajność algorytmu rekomntrującegom dlatego też, Milner zaprezentował bardziej efektywną impereatywną wariacją W nazwaną algorytmem J w \cite{Milner__1978}. 

Algorytm J jest funkcją, która dla dokonanych do tej pory substytucji $S$, środowiska - zbioru przechowywującego pary identyfikator wraz z typem $\Gamma$ i wyrażnia $e$, zwraca kolejne substytucje $S$, oraz typ wyrażenia $\tau$.
\begin{equation}
\begin{split}
